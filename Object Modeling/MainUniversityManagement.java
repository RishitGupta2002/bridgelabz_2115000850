...
public class MainUniversityManagement{
    public static void main(String[] args) {
        Professor profMath = new Professor("Dr. anita");
        Professor profSci = new Professor("Dr. pal");
        ...
        calculus.enrollStudent(Suresh);
        calculus.enrollStudent(shyam);
        physics.enrollStudent(Suresh);

        profMath.viewCourses();
        Suresh.viewEnrolledCourses();
    }
}